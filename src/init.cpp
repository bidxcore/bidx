...
/** Sanity checks
 *  Ensure that BIDX is running in a usable environment with all
...
{
    // Make sure only a single BIDX process is using the data directory.
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 11c: update block tip in BIDX modules
