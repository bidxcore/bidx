...
/** BIDX unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BIDXUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BIDXUnits(QObject *parent);
...
typedef BIDXUnits::Unit BIDXUnit;
