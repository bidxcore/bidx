    ...
    mapper(0)
{
    ...
    ui->openBIDXConfButton->setToolTip(ui->openBIDXConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BIDXUnits(this));
...
void OptionsDialog::on_openBIDXConfButton_clicked()
{
